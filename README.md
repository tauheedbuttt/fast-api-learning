...
2 - pip install -r requirements.txt ( uses existing configuration to setup server,  
 optional ).  
...
1 - Dependencies - how to define a callable Class and Function to use as reusable type  
 for FastAPI.  
